...
它是排障速查，不替代 `sch check`、`pcb check`、DRC、实时制造规则或本 skill 的阶段门。
...
- 新工程没有图纸：在属性面板的图纸设置中选择系统图纸模板；本 skill 自动化流程默认 A4，并遵守“无图纸不摆放/布线”。
...
- 浏览器右键/拖动触发鼠标手势：在浏览器设置中关闭手势，避免与 EDA 画布交互冲突。
