...
> 历史调研/提案（2026-08），下文“状态/当前/待补”描述当时版本，不是现行能力承诺。
> 当前原理图设计与修复遵守 [数据驱动架构基准](../skills/easyeda-agent/references/schematic-data.md#数据驱动架构基准)，
> 不以合并到 autolayout 或逐件现场修图取代区内/纸张数据链。命令现状看 CLI help 与 Skill。
